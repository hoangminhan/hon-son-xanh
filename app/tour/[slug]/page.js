    ...
    <div className="py-20 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-3xl overflow-hidden shadow-md">
          ...
          <div className="p-8">
            <div className="flex flex-wrap items-center gap-6 mb-8 border-b pb-6">
               <div>
                 <p className="text-sm text-slate-500 uppercase tracking-wider mb-1">Thời gian</p>
                 <p className="font-semibold text-slate-800">{tour.duration}</p>
               </div>
               <div>
                 <p className="text-sm text-slate-500 uppercase tracking-wider mb-1">Giá từ</p>
                 <p className="font-bold text-orange-600 text-xl">{tour.priceText}</p>
               </div>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-slate-800">Lịch trình</h2>
              <div className="prose prose-orange prose-lg max-w-none text-slate-600">
            ...
            {tour.included && tour.included.length > 0 && (
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-4 text-slate-800">Bao gồm</h2>
            ...
            {tour.note && (
              <div className="mb-8 p-6 bg-amber-50 rounded-2xl border border-amber-100">
                <h2 className="text-xl font-bold mb-3 text-amber-800">Lưu ý quan trọng</h2>
