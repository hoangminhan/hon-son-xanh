  ...
  return (
    <div className="py-20 bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors">
      <div className="container mx-auto px-4 max-w-3xl">
        <Link href="/blog" className="text-orange-600 dark:text-orange-400 hover:underline mb-8 inline-block font-medium">
          &larr; Quay lại danh sách bài viết
        </Link>
        
        <div className="mb-10">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 dark:text-white mb-6 leading-tight">{post.title}</h1>
